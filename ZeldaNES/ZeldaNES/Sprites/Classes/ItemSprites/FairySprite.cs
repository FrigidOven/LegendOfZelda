...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.FairySpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.FairySpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.FairySpriteStallFrameCount;
