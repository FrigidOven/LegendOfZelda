...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.HeartSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.HeartSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.HeartSpriteStallFrameCount;
