...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.MapSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.MapSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.MapSpriteStallFrameCount;
