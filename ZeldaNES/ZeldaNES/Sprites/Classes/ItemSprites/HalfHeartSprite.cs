...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.HalfHeartSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.HalfHeartSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.HalfHeartSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public HalfHeartSprite(IItem item) {
