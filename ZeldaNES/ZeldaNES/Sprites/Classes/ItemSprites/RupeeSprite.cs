...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.RupeeSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.RupeeSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.RupeeSpriteStallFrameCount;
