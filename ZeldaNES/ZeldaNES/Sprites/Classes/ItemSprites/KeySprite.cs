...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.KeySpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.KeySpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.KeySpriteStallFrameCount;
