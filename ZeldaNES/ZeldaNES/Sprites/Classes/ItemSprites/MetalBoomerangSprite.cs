...
{
    public class MetalBoomerangSprite : ISprite
    {
        static int SpriteIndex = ItemSpriteConstants.MetalBoomerangSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.MetalBoomerangSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.MetalBoomerangSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public MetalBoomerangSprite(IItem item) {
