...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.RecorderSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.RecorderSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.RecorderSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public RecorderSprite(IItem item) {
