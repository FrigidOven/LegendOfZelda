...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.BluePotionSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.BluePotionSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.BluePotionSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public BluePotionSprite(IItem item) {
