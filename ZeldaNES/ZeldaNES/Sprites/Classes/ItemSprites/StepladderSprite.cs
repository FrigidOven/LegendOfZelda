...
{
    public class StepladderSprite : ISprite
    {
        static int SpriteIndex = ItemSpriteConstants.StepladderSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.StepladderSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.StepladderSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public StepladderSprite(IItem item) {
