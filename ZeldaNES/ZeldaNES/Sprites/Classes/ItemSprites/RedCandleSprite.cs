...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.RedCandleSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.RedCandleSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.RedCandleSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public RedCandleSprite(IItem item) {
