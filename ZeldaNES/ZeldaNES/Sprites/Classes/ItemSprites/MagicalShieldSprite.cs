...
{
    public class MagicalShieldSprite : ISprite
    {
        static int SpriteIndex = ItemSpriteConstants.MagicalShieldSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.MagicalShieldSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.MagicalShieldSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public MagicalShieldSprite(IItem item) {
