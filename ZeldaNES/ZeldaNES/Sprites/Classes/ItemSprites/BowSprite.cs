...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.BowSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.BowSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.BowSpriteStallFrameCount;
