...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.HeartContainerSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.HeartContainerSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.HeartContainerSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public HeartContainerSprite(IItem item) {
