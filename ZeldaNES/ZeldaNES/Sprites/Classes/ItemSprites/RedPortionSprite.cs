...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.RedPotionSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.RedPotionSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.RedPotionSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public RedPotionSprite(IItem item) {
