...
{
    public class MagicalKeySprite : ISprite
    {
        static int SpriteIndex = ItemSpriteConstants.MagicalKeySpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.MagicalKeySpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.MagicalKeySpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public MagicalKeySprite(IItem item) {
