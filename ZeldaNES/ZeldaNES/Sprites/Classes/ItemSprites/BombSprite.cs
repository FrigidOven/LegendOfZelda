...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.BombSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.BombSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.BombSpriteStallFrameCount;
