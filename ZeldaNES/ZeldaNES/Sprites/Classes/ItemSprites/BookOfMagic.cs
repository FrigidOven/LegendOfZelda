...
{
    public class BookOfMagicSprite : ISprite
    {
        static int SpriteIndex = ItemSpriteConstants.BookOfMagicSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.BookOfMagicSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.BookOfMagicSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public BookOfMagicSprite(IItem item) {
