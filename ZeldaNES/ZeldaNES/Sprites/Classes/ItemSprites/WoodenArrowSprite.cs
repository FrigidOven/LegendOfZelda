...
{
    public class WoodenArrowSprite : ISprite
    {
        static int SpriteIndex = ItemSpriteConstants.WoodenArrowSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.WoodenArrowSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.WoodenArrowSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public WoodenArrowSprite(IItem item) {
