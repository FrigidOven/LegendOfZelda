...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.LetterSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.LetterSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.LetterSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public LetterSprite(IItem item) {
