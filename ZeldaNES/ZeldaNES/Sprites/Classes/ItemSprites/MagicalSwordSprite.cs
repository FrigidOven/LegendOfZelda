...
{
    public class MagicalSwordSprite : ISprite
    {
        static int SpriteIndex = ItemSpriteConstants.MagicalSwordSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.MagicalSwordSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.MagicalSwordSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public MagicalSwordSprite(IItem item) {
