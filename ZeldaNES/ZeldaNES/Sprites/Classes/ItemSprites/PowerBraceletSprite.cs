...
{
    public class PowerBraceletSprite : ISprite
    {
        static int SpriteIndex = ItemSpriteConstants.PowerBraceletSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.PowerBraceletSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.PowerBraceletSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public PowerBraceletSprite(IItem item) {
