...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.RedRingSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.RedRingSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.RedRingSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public RedRingSprite(IItem item) {
