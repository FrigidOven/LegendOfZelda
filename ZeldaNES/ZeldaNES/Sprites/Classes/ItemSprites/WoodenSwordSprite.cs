...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.WoodenSwordSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.WoodenSwordSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.WoodenSwordSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public WoodenSwordSprite(IItem item) {
