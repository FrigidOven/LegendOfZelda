...
{
    public class MetalSwordSprite : ISprite
    {
        static int SpriteIndex = ItemSpriteConstants.MetalSwordSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.MetalSwordSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.MetalSwordSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public MetalSwordSprite(IItem item) {
