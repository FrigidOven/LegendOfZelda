...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.TriforceSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.TriforceSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.TriforceSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public TriforceSprite(IItem item) {
