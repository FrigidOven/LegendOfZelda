...
{
    public class MetalArrowSprite : ISprite
    {
        static int SpriteIndex = ItemSpriteConstants.MetalArrowSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.MetalArrowSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.MetalArrowSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public MetalArrowSprite(IItem item) {
