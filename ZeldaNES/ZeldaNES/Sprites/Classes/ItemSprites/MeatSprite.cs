...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.MeatSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.MeatSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.MeatSpriteStallFrameCount;
