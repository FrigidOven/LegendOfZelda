...
{
    public class MagicalRodSprite : ISprite
    {
        static int SpriteIndex = ItemSpriteConstants.MagicalRodSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.MagicalRodSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.MagicalRodSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public MagicalRodSprite(IItem item) {
