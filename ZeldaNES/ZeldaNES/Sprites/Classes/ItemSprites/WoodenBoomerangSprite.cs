...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.WoodenBoomerangSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.WoodenBoomerangSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.WoodenBoomerangSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public WoodenBoomerangSprite(IItem item) {
