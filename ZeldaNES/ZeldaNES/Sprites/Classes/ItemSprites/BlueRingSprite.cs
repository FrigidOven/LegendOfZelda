...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.BlueRingSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.BlueRingSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.BlueRingSpriteStallFrameCount;
        ...
        int frameIndex;
        IItem owner;
        public BlueRingSprite(IItem item) {
