...
namespace ZeldaNES.Sprites.Classes.ItemSprites
{
    ...
    {
        static int SpriteIndex = ItemSpriteConstants.RaftSpriteIndex;
        static int SpriteFrameCount = ItemSpriteConstants.RaftSpriteFrameCount;
        static int SpriteStallFrameCount = ItemSpriteConstants.RaftSpriteStallFrameCount;
