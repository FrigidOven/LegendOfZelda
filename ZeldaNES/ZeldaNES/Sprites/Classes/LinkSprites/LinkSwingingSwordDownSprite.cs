...
{
    public class LinkSwingingSwordDownSprite : ISprite
    {
        ...
        public LinkSwingingSwordDownSprite(ILink link)
        {
            frames = new Rectangle[LinkSpriteConstants.SwingingSwordSpritesFrameCount];
            for(int i = 0; i < frames.Length; i++)
            {
                frames[i] = new Rectangle(LinkSpriteConstants.DownFacingSpritesIndex,
