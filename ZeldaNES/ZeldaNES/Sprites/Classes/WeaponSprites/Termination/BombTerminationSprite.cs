...
{
    public class BombTerminationSprite : ISprite
    {
        ...
        public BombTerminationSprite(IWeapon weapon)
        {
            frames = new Rectangle[WeaponSpriteConstants.BombTerminationSpritesFrameCount];
            for (int i = 0; i < frames.Length; i++)
            {
                frames[i] = new Rectangle(WeaponSpriteConstants.TerminationSpritesIndex,
                                          WeaponSpriteConstants.BombTerminationSpritesIndex + i * WeaponSpriteConstants.SpriteSize,
        ...
        public void Update()
        {
            if (frameIndex == frames.Length - 1 && stallFrameCounter == WeaponSpriteConstants.BombTerminationSpritesStallFrameCount)
            {
                weapon.ShouldDelete = true;
            }
            if (stallFrameCounter == WeaponSpriteConstants.BombTerminationSpritesStallFrameCount)
            {
                stallFrameCounter = 0;
