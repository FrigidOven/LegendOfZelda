...
namespace ZeldaNES.Sprites.Classes.WeaponSprites.WoodenBoomerang
{
    public class WoodenBoomerangGoingRightSprite : ISprite
    {
        ...
        public WoodenBoomerangGoingRightSprite(IWeapon weapon)
        {
            frames = new Rectangle[WeaponSpriteConstants.WoodenBoomerangSpritesFrameCount];
            for (int i = 0; i < frames.Length; i++)
            {
                frames[i] = new Rectangle(WeaponSpriteConstants.RightFacingSpritesIndex,
                                          WeaponSpriteConstants.WoodenBoomerangSpritesIndex + i * WeaponSpriteConstants.SpriteSize,
        ...
        public void Update()
        {
            if (stallFrameCounter == WeaponSpriteConstants.WoodenBoomerangSpritesStallFrameCount)
            {
                stallFrameCounter = 0;
