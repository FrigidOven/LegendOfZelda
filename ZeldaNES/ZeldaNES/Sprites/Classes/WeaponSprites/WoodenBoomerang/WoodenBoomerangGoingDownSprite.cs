...
{
    public class WoodenBoomerangGoingDownSprite : ISprite
    {
        ...
        public WoodenBoomerangGoingDownSprite(IWeapon weapon)
        {
            frames = new Rectangle[WeaponSpriteConstants.WoodenBoomerangSpritesFrameCount];
            for (int i = 0; i < frames.Length; i++)
            {
                frames[i] = new Rectangle(WeaponSpriteConstants.DownFacingSpritesIndex,
