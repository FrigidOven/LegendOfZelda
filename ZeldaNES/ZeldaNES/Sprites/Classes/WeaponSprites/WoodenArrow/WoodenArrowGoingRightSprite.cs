...
namespace ZeldaNES.Sprites.Classes.WeaponSprites.WoodenArrow
{
    public class WoodenArrowGoingRightSprite : ISprite
    {
        ...
        public WoodenArrowGoingRightSprite(IWeapon weapon)
        {
            frames = new Rectangle[WeaponSpriteConstants.WoodenArrowSpritesFrameCount];
            for (int i = 0; i < frames.Length; i++)
            {
                frames[i] = new Rectangle(WeaponSpriteConstants.RightFacingSpritesIndex,
                                          WeaponSpriteConstants.WoodenArrowSpritesIndex + i * WeaponSpriteConstants.SpriteSize,
        ...
        public void Update()
        {
            if (stallFrameCounter == WeaponSpriteConstants.WoodenArrowSpritesStallFrameCount)
            {
                stallFrameCounter = 0;
