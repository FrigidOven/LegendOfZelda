...
{
    public class BombTickingSprite : ISprite
    {
        ...
        public BombTickingSprite(IWeapon weapon)
        {
            frames = new Rectangle[WeaponSpriteConstants.BombSpritesFrameCount];
            for (int i = 0; i < frames.Length; i++)
            {
                frames[i] = new Rectangle(WeaponSpriteConstants.UpFacingSpritesIndex,
                                          WeaponSpriteConstants.BombSpritesIndex + i * WeaponSpriteConstants.SpriteSize,
        ...
        public void Update()
        {
            if (stallFrameCounter == WeaponSpriteConstants.BombSpritesStallFrameCount)
            {
                stallFrameCounter = 0;
