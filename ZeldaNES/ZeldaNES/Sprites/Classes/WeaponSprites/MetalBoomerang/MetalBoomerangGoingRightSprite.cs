...
namespace ZeldaNES.Sprites.Classes.WeaponSprites.MetalBoomerang
{
    public class MetalBoomerangGoingRightSprite : ISprite
    {
        ...
        public MetalBoomerangGoingRightSprite(IWeapon weapon)
        {
            frames = new Rectangle[WeaponSpriteConstants.MetalBoomerangSpritesFrameCount];
            for (int i = 0; i < frames.Length; i++)
            {
                frames[i] = new Rectangle(WeaponSpriteConstants.RightFacingSpritesIndex,
                                          WeaponSpriteConstants.MetalBoomerangSpritesIndex + i * WeaponSpriteConstants.SpriteSize,
        ...
        public void Update()
        {
            if (stallFrameCounter == WeaponSpriteConstants.MetalBoomerangSpritesStallFrameCount)
            {
                stallFrameCounter = 0;
