...
{
    public class GoriyaWalkingRightSprite : ISprite
    {
        ...
        static int SpriteDirectionFacing = DungeonEnemySpriteConstants.RightFacingSpritesIndex;
        ...
        int frameIndex;
        INPC owner;
        public GoriyaWalkingRightSprite(INPC owner) {
