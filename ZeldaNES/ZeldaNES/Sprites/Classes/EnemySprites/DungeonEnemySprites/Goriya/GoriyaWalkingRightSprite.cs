...
{
    public class GoriyaWalkingUpSprite : ISprite
    {
        ...
        static int SpriteDirectionFacing = DungeonEnemySpriteConstants.UpFacingSpritesIndex;
        ...
        int frameIndex;
        INPC owner;
        public GoriyaWalkingUpSprite(INPC owner) {
