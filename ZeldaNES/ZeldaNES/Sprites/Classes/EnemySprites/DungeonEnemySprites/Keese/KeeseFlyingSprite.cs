...
{
    public class KeeseFlyingSprite : ISprite
    {
        static int SpriteIndex = DungeonEnemySpriteConstants.KeeseSpritesIndex;
        static int SpriteFrameCount = DungeonEnemySpriteConstants.KeeseSpritesFrameCount;
        static int SpriteStallFrameCount = DungeonEnemySpriteConstants.KeeseSpritesStallFrameCount;
        ...
        int frameIndex;
        INPC owner;
        public KeeseFlyingSprite(INPC owner) {
