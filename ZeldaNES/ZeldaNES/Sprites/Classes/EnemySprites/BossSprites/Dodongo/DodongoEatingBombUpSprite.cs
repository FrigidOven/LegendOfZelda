...
{
    public class DodongoEatingBombUpSprite : ISprite
    {
        ...
        public DodongoEatingBombUpSprite(INPC dodongo)
        {
            ...
            {
                frames[i] = new Rectangle(DungeonEnemySpriteConstants.UpFacingSpritesIndex,
