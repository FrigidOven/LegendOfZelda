...
{
    public class DodongoEatingBombRightSprite : ISprite
    {
        ...
        public DodongoEatingBombRightSprite(INPC dodongo)
        {
            frames = new Rectangle[DungeonEnemySpriteConstants.DodongoEatingBombSpritesFrameCount];
            for (int i = 0; i < DungeonEnemySpriteConstants.DodongoEatingBombSpritesFrameCount; i++)
            {
                frames[i] = new Rectangle(DungeonEnemySpriteConstants.RightFacingSpritesIndex,
                                          DungeonEnemySpriteConstants.DodongoEatingBombSpritesIndex + i * DungeonEnemySpriteConstants.SpriteSize,
        ...
        public void Update()
        {
            if (stallFrameCounter == DungeonEnemySpriteConstants.DodongoEatingBombSpritesStallFrameCount)
            {
                stallFrameCounter = 0;
