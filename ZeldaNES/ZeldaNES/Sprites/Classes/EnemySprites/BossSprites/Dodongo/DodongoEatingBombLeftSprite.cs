...
{
    public class DodongoEatingBombLeftSprite : ISprite
    {
        ...
        public DodongoEatingBombLeftSprite(INPC dodongo)
        {
            ...
            {
                frames[i] = new Rectangle(DungeonEnemySpriteConstants.LeftFacingSpritesIndex,
