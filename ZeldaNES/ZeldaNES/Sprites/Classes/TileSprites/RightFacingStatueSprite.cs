...
{
    public class RightFacingStatueSprite : ISprite
    {
        static int SpriteIndex = DungeonTileSpriteConstants.RightFacingStatueSpriteIndex;
        ...
        int frameIndex;
        ITile owner;
        public RightFacingStatueSprite(ITile item) {
