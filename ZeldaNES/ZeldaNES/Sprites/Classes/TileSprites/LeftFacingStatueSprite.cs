...
{
    public class LeftFacingStatueSprite : ISprite
    {
        static int SpriteIndex = DungeonTileSpriteConstants.LeftFacingStatueSpriteIndex;
        ...
        int frameIndex;
        ITile owner;
        public LeftFacingStatueSprite(ITile item) {
