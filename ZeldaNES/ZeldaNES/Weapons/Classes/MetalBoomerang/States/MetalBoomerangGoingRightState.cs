...
{
    public class MetalBoomerangGoingRightState : IWeaponState
    {
        private MetalBoomerang metalBoomerang;
        private ISprite sprite;
        private IWeaponUser owner;

        public MetalBoomerangGoingRightState(MetalBoomerang metalBoomerang, IWeaponUser owner)
        {
            this.metalBoomerang = metalBoomerang;
            this.owner = owner;
            sprite = new MetalBoomerangGoingRightSprite(metalBoomerang);
        }
        public void Update()
        {
            sprite.Update();
