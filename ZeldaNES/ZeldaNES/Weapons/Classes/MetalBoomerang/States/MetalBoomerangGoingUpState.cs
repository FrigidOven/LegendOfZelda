...
{
    public class MetalBoomerangGoingUpState : IWeaponState
    {
        private MetalBoomerang metalBoomerang;
        private ISprite sprite;
        private IWeaponUser owner;

        public MetalBoomerangGoingUpState(MetalBoomerang metalBoomerang, IWeaponUser owner)
        {
            this.metalBoomerang = metalBoomerang;
            this.owner = owner;
            sprite = new MetalBoomerangGoingUpSprite(metalBoomerang);
        }
        public void Update()
        {
            sprite.Update();
