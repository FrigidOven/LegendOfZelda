...
{
    public class WoodenBoomerangGoingLeftState : IWeaponState
    {
        ...
        public WoodenBoomerangGoingLeftState(WoodenBoomerang woodenBoomerang, IWeaponUser owner)
        {
            this.owner = owner;
            this.woodenBoomerang = woodenBoomerang;
            sprite = new WoodenBoomerangGoingLeftSprite(woodenBoomerang);
        }
        public void Update()
        {
            sprite.Update();
