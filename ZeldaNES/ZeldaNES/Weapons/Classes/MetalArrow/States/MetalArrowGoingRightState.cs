...
{
    public class MetalArrowGoingRightState : IWeaponState
    {
        private MetalArrow metalArrow;
        private ISprite sprite;

        public MetalArrowGoingRightState(MetalArrow metalArrow)
        {
            this.metalArrow = metalArrow;
            sprite = new MetalArrowGoingRightSprite(metalArrow);
        }
        public void Update()
        {
            sprite.Update();
