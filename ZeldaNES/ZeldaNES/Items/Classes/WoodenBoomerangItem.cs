...
{   
    public class WoodenBoomerangItem: IEquippableItem
    {
        public int PosX
        {
            get => body.PosX;
        ...
        public WoodenBoomerangItem() {
            body = new ItemPhysicsObject(0, 0);

            spriteRef = new WoodenBoomerangSprite(this);
        }
        public WoodenBoomerangItem(int x, int y)
        {
