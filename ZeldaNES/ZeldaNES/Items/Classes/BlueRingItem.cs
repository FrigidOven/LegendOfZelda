...
{   
    public class BlueRingItem: IPassiveItem, IUpgradeItem
    {
        public int PosX
        {
            get => body.PosX;
        ...
        {
            return GeneralConstants.UpgradeClasses.Ring;
        }
        public int GetLevel()
        {
            return 0;
        ...
        public BlueRingItem() {
            ...
            spriteRef = new BlueRingSprite(this);
        }
        public BlueRingItem(int x, int y)
        {
