...
using ZeldaNES.Doors1.HiddenDoor.States;

namespace ZeldaNES.Doors1.HiddenDoor
{
    public class HiddenDoor : IDoor
    {
        private int index;
        private int posX;
        private int posY;
