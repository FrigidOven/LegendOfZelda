...
{
    public class NorthLockedDoorState : IDoorState
    {
        ...
        public void Open()
        {
            Door.SetState(new NorthOpenDoorState(Door));
