...
{
    public class LinkStoppedLeftState : ILinkState
    {
        private Link link;
        ...
        public LinkStoppedLeftState(Link link)
        {
            this.link = link;
        ...
        private void ReorientateSword()
        {
            link.Body().SwordHitbox = new Hitbox(link.PosX,
                                          link.PosY,
                                          PlayerConstants.LinkLeftSwordHitboxXOffset,
                                          PlayerConstants.LinkLeftSwordHitboxYOffset,
                                          PlayerConstants.LinkLeftSwordHitboxWidth,
                                          PlayerConstants.LinkLeftSwordHitboxHeight,
                                          false);
        }
        public void Update()
        {
        ...
        {
            this.link.SetState(new LinkWalkingLeftState(this.link));
        }
