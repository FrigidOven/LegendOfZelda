...
{
    internal class SmallJellyMovingRightState : ISmallJellyStates
    {
        SmallJellyEnemy smallJellyReference;
        ISprite sprite;
        public void Update()
        {
            smallJellyReference.PosX += EnemyConstants.SmallJellyMovementSpeed;
            sprite.Update();
        }
        public void Draw()
        {
        ...
        public SmallJellyMovingRightState(SmallJellyEnemy smallJelly)
        {
