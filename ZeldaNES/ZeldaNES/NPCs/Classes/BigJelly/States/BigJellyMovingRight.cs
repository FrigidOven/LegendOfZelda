...
{
    internal class BigJellyMovingRightState : IBigJellyStates
    {
        BigJellyEnemy bigJellyReference;
        ISprite sprite;
        public void Update()
        {
            bigJellyReference.PosX -= EnemyConstants.BigJellyMovementSpeed;
            sprite.Update();
        }
        public void Draw()
        {
        ...
        public BigJellyMovingRightState(BigJellyEnemy bigJelly)
        {
