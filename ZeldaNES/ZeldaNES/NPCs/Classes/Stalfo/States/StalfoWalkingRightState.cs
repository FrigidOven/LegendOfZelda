...
{
    internal class StalfoWalkingRightState : IStalfoStates
    {
        StalfoEnemy stalfoReference;
        private ISprite sprite;
        public void Update()
        {
            stalfoReference.PosX += EnemyConstants.StalfoMovementSpeed;
            sprite.Update();
        }
        public void Draw()
        {
        ...
        public StalfoWalkingRightState(StalfoEnemy stalfo)
        {
