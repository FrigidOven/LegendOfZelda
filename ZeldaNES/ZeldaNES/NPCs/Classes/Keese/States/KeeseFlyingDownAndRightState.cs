...
{
    internal class KeeseFlyingDownAndRightState: IKeeseStates
    {
        ...
        public void Update()
        {
            ...
            keeseReference.PosY += EnemyConstants.KeeseMovementSpeed;
            sprite.Update();
        }
        public void Draw()
        {
        ...
        public  KeeseFlyingDownAndRightState(KeeseEnemy keese) {
